...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container">
      <a class="navbar-brand" href="#"><span><h2 ><b class="text-warning">YO|</b>voyage</h2></span></a>
  ...
  <div class="container mt-5">
    <div class="row bg-dark avis">
      @foreach ($commentaires as $commentaire)
      <div class="card bg-white commentaire">
        <h5 class="card-header"><b class="fas fa-star">Commentaire Client</b></h5>
        <div class="card-body">
             <p><strong>{{ $commentaire->chaufffeur }}</strong> </p> 
            <hr>
            <p>{{ $commentaire->commentaire }}</p>
            <p>
               @for ($i = 1; $i <= $commentaire->note; $i++)
                   <b class="text-warning"><i class="fas fa-star">*</i></b>
                @endfor
            </p>
        </div>
        </div>
