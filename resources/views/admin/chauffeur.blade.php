        ...
        <div id="body" class="active">
            ...
            <div class="content">
                <div class="container">
                  ...
                  <!-- Modal -->
                  <div class="modal fade" id="addChauffeurModal" tabindex="-1" role="dialog" aria-labelledby="addCandidatModalLabel" aria-hidden="true">
                      <div class="modal-dialog" role="document">
                          <div class="modal-content">
                              ...
                              <div class="modal-body">
                                  ...
                                  <form action="{{route('ajoutChauffeur')}}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="numero_permit" name="numero_permit" required>
                                    </div>
                                    <div class="form-group">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modifierChauffeur{{ $chauffeur->id }}">
                                                Modifier
                                            </button>
                                            @foreach($chauffeurs as $chauffeur)
<!-- Modal de modification pour le chauffeur {{$chauffeur->id}} -->
                                                <div class="modal fade" id="modifierChauffeur{{ $chauffeur->id }}" tabindex="-1" role="dialog" aria-labelledby="modifierChauffeurLabel{{ $chauffeur->id }}" aria-hidden="true">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="modifierChauffeurLabel{{ $chauffeur->id }}">Modifier Chauffeur {{ $chauffeur->nom }} {{ $chauffeur->prenom }}</h5>
                                                                <button type="button" class="close" data-dismiss="modal" aria-label="Fermer">
                                                                    <span aria-hidden="true">&times;</span>
                                                                </button>
                                                            </div>
                                                            <form action="{{ route('updateChauffeur', $chauffeur->id) }}" method="POST">
                                                                @csrf
                                                                @method('PUT')
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="experience">Expérience</label>
                                                                        <input type="number" class="form-control" id="experience" name="experience" value="{{ $chauffeur->experience }}" required>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label for="numero_permit">Numéro de permis</label>
                                                                        <input type="text" class="form-control" id="numero_permit" name="numero_permit" value="{{ $chauffeur->numero_permit }}" required>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label for="date_emission">Date d'émission du permis</label>
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="date_expiration">Date d'expiration du permis</label>
                                                                        <input type="date" class="form-control" id="date_expiration" name="date_expiration" value="{{ $chauffeur->date_expiration }}" required>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label for="Deplacement">Déplacement</label>
                                                                        <select class="form-control" id="Deplacement" name="Deplacement" required>
                                                                            <option value="1" {{ $chauffeur->Deplacement ? 'selected' : '' }}>Oui</option>
                                                                            <option value="0" {{ !$chauffeur->Deplacement ? 'selected' : '' }}>Non</option>
                                                                        </select>
                                                                    </div>
                                                                </div>
                                            ...
                                            <form action="{{ route('deleteChauffeur', $chauffeur->id) }}" method="POST" style="display: inline;">
                                                @csrf
                                                @method('DELETE')
